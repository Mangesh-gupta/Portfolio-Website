...
import { ArrowUp, Heart, Code2, Mail, Sparkles } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-8 border-b border-slate-800">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Assistant System Engineer @ TCS | Claude Certified Architect
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="p-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white transition-colors"
              aria-label="Email Mangesh"
            >
              <Mail className="w-4 h-4" />
            </a>
            <button
              onClick={scrollToTop}
              className="p-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white transition-colors shadow-sm"
